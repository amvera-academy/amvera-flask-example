...
[КАК СОХРАНЯТЬ БД](#как-правильно-сохранять-бд) | [СТАТИЧЕСКИЕ ФАЙЛЫ](#статические-файлы) | [CELERY](https://github.com/latuk993/amvera-fastapi-example/blob/main/CELERY.md) | [КАК ЗАПУСТИТЬ НА AMVERA](#деплой-в-amvera)
